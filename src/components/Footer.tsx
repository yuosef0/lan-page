        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-white/80">
              {contactInfo?.footer_tagline || 'Building visions into reality since 2005.'}
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-sm text-white/80">
              <li>{contactInfo?.office_email || 'contact@apexbase.com'}</li>
              <li>{contactInfo?.office_phone || '(123) 456-7890'}</li>
              <li className="text-xs">
                {contactInfo?.office_address || '123 Construction Ave'}
              </li>
            </ul>
          </div>
